...
const Update: React.FC<UpdateProps> = ({ isOpen, setIsOpen, formData, setFormData, handleSubmit }) => {
            ...
            <DialogContent className="sm:max-w-[765px]">
                ...
                <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <DateTime dateFormat={false} timeFormat="HH:mm" value={formData.actualEndTime} onChange={handleActualEndTimeChange} /> 
                    </div>
                </div>
                <DialogFooter>
